...
const AthleteDetailAnalysis = lazy(
  () => import("./pages/AthleteDetailAnalysis")
);
            ...
            <Suspense fallback={<div className="p-6">Ładowanie…</div>}>
              <Routes>
                ...
                <Route element={<DashboardLayout />}>
                  ...
                  <Route
                    path="/analyzer/athlete/:id"
                    element={<AthleteDetailAnalysis />}
                  />
                  <Route
                  ...
                  />
                  <Route
                    path="/analyzer/weekly-report"
                    element={<WeeklyReport />}
                  />
                  <Route
                    path="/analyzer/training-zones"
                    element={<TrainingZones />}
                  />
