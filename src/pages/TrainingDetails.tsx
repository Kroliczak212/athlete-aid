    ...
    insights: [
      {
        ...
        description:
          'Sportowiec bardzo dobrze utrzymał planowane tempo w sekcji interwałowej. Różnica między planowanym a rzeczywistym tempem wynosiła tylko 2%.',
        confidence: 94,
      },
      {
        type: 'warning',
        ...
        description:
          'W 3 momentach treningu tętno przekroczyło strefę progową o więcej niż 10 bpm, co może wskazywać na zbyt wysoką intensywność.',
        confidence: 87,
      },
      {
        type: 'info',
        ...
        description:
          'Regularność tętna wskazuje na kontrolowane oddychanie przez większość treningu.',
        confidence: 91,
      },
    ],
    recommendations: [
    ...
    <div className="p-4 lg:p-6 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold tracking-tight">Szczegóły treningu</h1>
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <Card className="border-border bg-card">
              <CardHeader>
                ...
                <CardDescription>
                  Śr: {training.actualData.avgHeartRate} bpm • Maks:{' '}
                  {training.actualData.maxHeartRate} bpm
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-border bg-card">
              <CardHeader>
                ...
                <CardDescription>Średnie tempo: {training.actualData.avgPace}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Rozkład czasu treningu w poszczególnych strefach tętna
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="plan" className="space-y-4">
          <Card className="border-border bg-card">
            <CardHeader>
              ...
              <CardDescription>Szczegółowy plan ćwiczeń na dzisiejszy trening</CardDescription>
            </CardHeader>
            <CardContent>
