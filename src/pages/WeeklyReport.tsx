...
export default function WeeklyReport() {
  ...
  const planAdherence = (mockWeeklyData.sessionsCompleted.filter(s => s.planned).length / mockWeeklyData.plannedSessions) * 100;
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground">
            Szczegółowy raport aktywności treningowej
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Zaplanowane: {mockWeeklyData.plannedSessions}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{Math.floor(mockWeeklyData.totalTime / 60)}h {mockWeeklyData.totalTime % 60}min</p>
                <p className="text-xs text-muted-foreground">Średnio: {Math.round(mockWeeklyData.totalTime / mockWeeklyData.totalSessions)}min/sesja</p>
              </div>
      ...
      <Card className="border-border bg-card">
        <CardHeader>
          ...
          <CardDescription>
            Stopień przestrzegania zaplanowanych treningów
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Wykonano {mockWeeklyData.sessionsCompleted.filter(s => s.planned).length} z {mockWeeklyData.plannedSessions} zaplanowanych sesji
          </p>
        </CardContent>
      </Card>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant={session.planned ? "default" : "secondary"} className="text-xs">
